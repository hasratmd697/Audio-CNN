...
class AudioCNN(nn.Module):
    def __init__(self, num_classes=50):
        ...
        self.layer2 = nn.ModuleList([ResidualBlock(128 if i == 0 else 256, 256) for i in range(6)])
        self.layer2 = nn.ModuleList([ResidualBlock(256 if i == 0 else 512, 512) for i in range(3)])
